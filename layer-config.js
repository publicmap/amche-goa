export const layersConfig = [
    ...
    {
        title: 'Steep Plots',
        description: 'Cadastral plot locations with steep slopes. Processed using slope computed with NASADEM 30m data and cadastral boundaries from OneMapGoa GIS. See <a href="https://github.com/publicmap/amche-goa/tree/main/data/slope">processing code</a> for details.',
        ...
        inspect: {
            id: 'plot',
            title: '% plot area with steep slopes',
            label: 'steep_slope_pct',
            fields: ['plot','slope_10_20_percent','slope_20_25_percent','slope_25_35_percent','slope_35_inf_percent','village'],
            fieldTitles: ['Plot','10-20% slope %','20-25% slope %','25-35% slope %','35%+ slope %','Village']
        }
    },
    {
