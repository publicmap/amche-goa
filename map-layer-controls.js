class MapLayerControl {
    ...
    _createPopupContent(feature, group, isHover = false, lngLat = null) {
        ...
        // One Map Goa link
        const oneMapGoaLink = document.createElement('a');
        ...
        oneMapGoaLink.href = `https://onemapgoagis.goa.gov.in/map/?ct=LayerTree${oneMapGoaLayerList}&bl=mmi_hybrid&t=goa_default&c=${mercatorCoords.x}%2C${mercatorCoords.y}&s=500`;
        oneMapGoaLink.target = '_blank';
        oneMapGoaLink.className = 'flex items-center gap-1 hover:text-gray-900';
        oneMapGoaLink.innerHTML = `
            <img src="https://onemapgoagis.goa.gov.in/static/images/oneMapGoaLogo1mb.gif" 
                class="w-5 h-5" 
                alt="One Map Goa">
        `;
