...
const ASSETS_TO_CACHE = [
  ...
  '/assets/js/map-layer-controls.js',
  '/assets/js/geolocation-control.js',
  '/assets/js/mapbox-gl-view-control.js',
  '/assets/js/layer-config.js',
  '/assets/js/map-utils.js',
  '/utils.js',
  '/assets/js/layer-order-manager.js',
  '/assets/js/map-feature-state-manager.js',
